...
const Journal = () => {
    return (
        <main className="common-page journal-page">
            <h1 className="site-name">Винoписи</h1>

            <div className="common-page-wrapper">
                <Aside/>
                <article className="common-page-article journal-article">
                    <div className="common-page-heading-wrapper">
                        <span className="common-page-heading">ВИНОПИСИ</span>
                    </div>
                    ...
                    <a className="common-page-button" href="#">Виж винописите<i className="fas fa-angle-double-right"></i></a>
                </article>
